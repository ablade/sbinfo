...
<div class="jumbotron">
    <h1>Welcome to Asentria-IR</h1>
    <p>Asentria Installation Reporting (AIR) is an application to view information about Siteboss installation information.
    Receive online payments from your clients and improve your cash flow
	  </p>
    <p>{{ link_to('session', 'Login Now &raquo;', 'class': 'btn btn-primary btn-large btn-success') }}</p>
</div>
