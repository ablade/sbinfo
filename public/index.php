...
try {
     ...
     * loader registers the App directory and registers the Service class
     * globally.
     */
    require APP_PATH . 'app/config/loader.php';

    /**
     * Alot of magic goes here Services descripted in Services.php that is
     * loaded gets initialize.  Then its passed on to the dispatcher to the
     * SecurityPlugin in the app/plugin folder
     * 
     */ 
